...
| screen           | Screen element                                                                                  | [Screen](/json-ui/json-ui-documentation#screen) <br> [Control](/json-ui/json-ui-documentation#control) <br> [Layout](/json-ui/json-ui-documentation#layout) <br> [Data Binding](/json-ui/json-ui-documentation#data-binding)                                                                                                                                                                                                                   |
...
| consume_hover_events               |                                        boolean                                         |               | When set to false, it prevents the element from being hovered |
...
| Property Name                |                                                     Type                                                      | Default Value | Description                                                                                                                                                                                     |
| ---------------------------- | :-----------------------------------------------------------------------------------------------------------: | :-----------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| default_focus_precedence     |                                                      int                                                      |               | Precedence over the other inputs on screen for being selected once the screen is opened                                                                                                       |
...
| duration                  |    number     | Time in seconds this animations takes to finish                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| next                      |    string     | The name of the next animation to play once this one is finished                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| from                      |               | The initial value of the property affected by anim_type                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| to                        |               | The final value of the property offected by this animation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
